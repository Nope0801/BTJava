package org.hina.w06.Ex3;

import org.hina.w06.Ex3.Paint2D.*;
...
public class mainTest {
    ...
    public static void MinMaxArea(IShapeT[] list) {
        ...
        System.out.println("Shape with the largest area is " + maxShape + " with the area of " + max + "");
        System.out.println("Shape with the smallest area is " + minShape + " with the area of " + min + "");
    }
    ...
    public static void main(String[] args) {
        ...
        printList(list);
        System.out.println();
        System.out.println("Total sum of all shapes' perimeter: " + CalcListPara(list));
        System.out.println("Total sum of all shapes' area: " + CalcListArea(list));
        MinMaxArea(list);
        System.out.println();
